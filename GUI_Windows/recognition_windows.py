...
class ImageRecognitionGUI(QWidget):
    ...
    def select_new_images(self):    # Display each image and filename on GUI
        ...
        folder_name = r"C:\Users\User\Desktop\GUI_Windows\split_images_recog" 
    ...
    def take_image(self):   # Take 5 Images  (does not work for Arducam 64MP)
    ...
    def splitting_image(self, rows, cols):    # Split Images and move the images to split_images folder 
        folder_path = r"C:\Users\User\Desktop\GUI_Windows\split_images_recog"
        if not os.path.exists(folder_path):
            os.makedirs(folder_path)

        source_dir = r"C:\Users\User\Desktop\GUI_Windows\save_images_recog"
        destination_dir = r"C:\Users\User\Desktop\GUI_Windows\split_images_recog"

        source_dir2 = r"C:\Users\User\Desktop\GUI_Windows"
